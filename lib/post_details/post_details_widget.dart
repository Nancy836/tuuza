                ...
                Expanded(
                  child: StreamBuilder<UsersRecord>(
                    stream: UsersRecord.getDocument(
                        postDetailsPostsRecord.postAuthor),
                    builder: (context, snapshot) {
                      // Customize what your widget looks like when it's loading.
                      if (!snapshot.hasData) {
                        return Center(
                      ...
                      final postDetailUsersRecord = snapshot.data;
                      return SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              padding:
                                  EdgeInsetsDirectional.fromSTEB(16, 4, 16, 20),
                              child: Row(
                                mainAxisSize: MainAxisSize.max,
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceBetween,
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Text(
                                                                          dateTimeFormat(
                                                                              'relative',
                                                                              commentListCommentsRecord.commentDate),
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodyText2
                                                                              .override(
                                                                                fontFamily: 'Poppins',
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    final commentsCreateData =
                                      ...
                                      commentDescription: textController.text,
                                      commentAuthor: currentUserReference,
                                      postId: postDetailsPostsRecord.reference,
                                    );
