...
class Profile2CopyWidget extends StatefulWidget {
  const Profile2CopyWidget({Key key}) : super(key: key);

  @override
  _Profile2CopyWidgetState createState() => _Profile2CopyWidgetState();
}

class _Profile2CopyWidgetState extends State<Profile2CopyWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final profile2CopyUsersRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
