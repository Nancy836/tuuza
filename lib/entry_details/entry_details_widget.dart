...
import '../components/delete_entry_widget.dart';
...
class EntryDetailsWidget extends StatefulWidget {
  const EntryDetailsWidget({
    Key key,
    this.entryReference,
  }) : super(key: key);

  final DocumentReference entryReference;

  @override
  _EntryDetailsWidgetState createState() => _EntryDetailsWidgetState();
}

class _EntryDetailsWidgetState extends State<EntryDetailsWidget> {
  final scaffoldKey = GlobalKey<ScaffoldState>();

  @override
  Widget build(BuildContext context) {
    return StreamBuilder<EntriesRecord>(
      stream: EntriesRecord.getDocument(widget.entryReference),
      builder: (context, snapshot) {
        ...
        final entryDetailsEntriesRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
          ...
          floatingActionButton: FloatingActionButton(
            ...
            child: StreamBuilder<EntriesRecord>(
              ...
              builder: (context, snapshot) {
                ...
                final iconButtonEntriesRecord = snapshot.data;
                              ...
                              child: ClipRRect(
                                ...
                                child: CachedNetworkImage(
                                  imageUrl: valueOrDefault<String>(
                                    entryDetailsEntriesRecord.entryimage,
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                entryDetailsEntriesRecord.mood,
                                style: FlutterFlowTheme.of(context)
                                    .bodyText1
                                    .override(
                                      fontFamily: 'Poppins',
                                ...
                                children: [
                                  Text(
                                    valueOrDefault<String>(
                                      entryDetailsEntriesRecord.entryname,
                                      'My journal entry',
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyText1
                                ...
                                children: [
                                  Text(
                                    dateTimeFormat('yMMMd',
                                        entryDetailsEntriesRecord.entrydate),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyText1
                                        .override(
                                          fontFamily: 'Poppins',
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  valueOrDefault<String>(
                                    entryDetailsEntriesRecord.entrydescription,
                                    'This is how i feel',
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyText1
